...
nouveau.addEventListener('click', () => {
    ...
    //on oublie pas de préciser l'index des citations ds notre tableau 
    auteur.textContent = citations[nombreAleatoire][1];
    //on oublie pas de préciser l'index des auteurs ds notre tableau
    dernier = nombreAleatoire
    //permet de ne jamais avoir la même sitation à la suite
});
